...
def fitsed(
    ...
    fixedhe : float = typer.Option(None, "--fixedhe", help="Layer at which to fix the H/He ratio."),
    # --- column names ---
    source_id: str = typer.Option("gaia_dr3_source_id", "--source-id", help="Column name for source IDs."),
    ra: str = typer.Option("ra", "--ra", help="Column name for RA."),
    dec: str = typer.Option("dec", "--dec", help="Column name for Dec."),
    parallax: str = typer.Option("parallax", "--parallax", help="Column name for parallax."),
    parallax_error: str = typer.Option("parallax_error", "--parallax-error", help="Column name for parallax error."),
