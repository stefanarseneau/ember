...
def leastsq_likelihood(params, fl, e_fl, plx, interp, logg_function, units = "fnu"):
...
def mcmc_likelihood(theta, fl, e_fl, plx_prior, av_prior, likelihood, ext_vector, units = "fnu", logg_function = None, vg_prior = None, fixed_distance = None, fixed_av = None):
    ...
    ll  = likelihood.ll(theta, fl*10**(-0.4*ext_vector*av), e_fl, logg_function = logg_function, use_jy = use_jy)
